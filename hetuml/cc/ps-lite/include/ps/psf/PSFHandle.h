#ifndef __HETU_ML_PS_PSF_PSF_HANDLE_H_
#define __HETU_ML_PS_PSF_PSF_HANDLE_H_
 ...
 *        vals is vals.
 *        One key (two keys for binary op) per request in HetuML.
 *        Question: Is it ok in a lock-free manner?
 */
...
#endif // __HETU_ML_PS_PSF_PSF_HANDLE_H_
