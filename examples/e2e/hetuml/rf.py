...
if __name__ == "__main__":
    ...
    parser.add_argument("--ins_sp_ratio", type=float, default=0.8, help="Instance sampling ratio")
    parser.add_argument("--feat_sp_ratio", type=float, default=0.8, help="Instance sampling ratio")
    ...
    if args.role == "server":
        ...
        model = RanomBoostedForest(
            ...
            ins_sp_ratio=args.ins_sp_ratio, 
            feat_sp_ratio=args.feat_sp_ratio, 
