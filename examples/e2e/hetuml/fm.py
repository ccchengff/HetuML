...
from hetuml.factorization_machines import FM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embedding_dim", type=int, default=8, help="Size of embedding size")
    ...
    if args.role == "server":
        cluster.start_server(FM.ps_data_type)
